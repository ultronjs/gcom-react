    ...
    <div className="form_container">
        <div className="form sign_up">
            ...
            <div className="input_group">
                ...
                <input className="input_regular input_corner" type="text" placeholder="Full Name" />
            </div>
            <div className="input_group">
            ...
            <div className="input_group">
                ...
                <input className="input_regular input_corner" type="password" placeholder="Enter same as password" />
